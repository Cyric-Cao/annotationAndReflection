...
public class OperateToScript {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String str = "var user = {name:'zhangsna',age:18,schools:['清华大学','北京大学']};";
        str += "println(user.name);";

        //执行脚本
        engine.eval(str);
        engine.eval("msg = 'asa is a good school';");
        ...
        URL url = OperateToScript.class.getClassLoader().getResource("a.js");
